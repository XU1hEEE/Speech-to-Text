...
==================================================
Description:
    Defines the PyTorch Dataset class for loading neural activity and 
    aligned phoneme sequences. Handles multi-day recording sessions 
    by flattening the trial structure while preserving session (day) 
    indices for domain adaptation.
...
Location:
    neural_seq_decoder/src/neural_decoder/dataset.py
"""
